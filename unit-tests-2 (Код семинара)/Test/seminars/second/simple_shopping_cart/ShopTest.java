...
*/
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        // Assert
        assertEquals(250 * 3 + 200, cart.getTotalPrice(), 0.00001);
    }
...
//        assertThat(cart.getTotalPrice()).isEqualTo(170 + 250 + 200 + 150 - 250);
        assertEquals(170 + 250 + 200 + 150 - 250, cart.getTotalPrice(), 0.00001);
    }
    ...
    void quantityProductsStoreChanging() {
        Integer quantityBefore = shop.getProductsShop().get(0).getQuantity();
        for (int i = 0; i < 4; i++) {
            cart.addProductToCartByID(1);
        }
        Integer quantityAfter = shop.getProductsShop().get(0).getQuantity();
    ...
    void deletedProductIsReturnedToShop() {
        Integer quantityBefore = shop.getProductsShop().get(2).getQuantity();
        for (int i = 0; i < 5; i++) {
            cart.addProductToCartByID(3);
        }
        ...
        Integer quantityAfter = shop.getProductsShop().get(2).getQuantity();

        assertThat(quantityBefore - quantityAfter).isEqualTo(2);
    ...
    @Disabled("The test is completed!")

    void AdvancedTest() {
        cart.addProductToCartByID(2); // 250
        cart.addProductToCartByID(2); // 250

        assertEquals(cart.getTotalPrice(), 500);
    }
}